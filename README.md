...
- value prop: ever felt jealous of your friends at penn or uchicago where they have such strong "house culture" and you're sick of hearing about it when you come back to your silent corridor style dorm and then you start wishing you had made more use of being in john jay or carman where all your peers were back in freshmen year? (Columbia house culture? never heard of her) Well, this app is here to fix that 😩👏. Find your interest group and your most likely squad with brand new faces. Like OL groups but with people who you actually share interests with, not with those random faces that you don't even remember now. Idea is to match people in pods, bypassing the awkwardness of admitting that they wished they were more social back in freshmen year, rather than conform to the social norm that it's not acceptable to seek out new friends in junior year. Dormpod, Groove, Squad (new year, new squad)
